...
class TestChordProgressions:
    ...
    def test_leading_tone_resolution(self):
        ...
        lt_errors_one = lt_prog_one.validate_progression(test_validator)

        #I - iii - IV - V7
        lt_prog_two = self.create_progression(['Cb2,Cb3,Gb4,Eb5','Eb3,Bb3,Gb4,Eb5','Fb3,Ab3,Fb4,Cb4','Gb3,Gb3,Fb4,Bb4'],'Cb')
        lt_errors_two = lt_prog_two.validate_progression(test_validator)
    ...
    def test_spelling_errors(self):
        """Testing for basic chordal spelling errors as errors with voice range, voice spacing, and notes used."""
        ...
        test_spacing_errors = test_spacing_prog.validate_progression(test_validator)
        ...
        test_range_errors = test_range_prog.validate_progression(test_validator)
